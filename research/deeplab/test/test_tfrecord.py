...
print("Verifying {}".format(tfrecords_filename))
for tfrecord in os.listdir(tfrecords_filename):
    ...
    for string_record in record_iterator:
        ...
        with tf.Session(config=config) as sess:
            ...
            print("Verification Image Consistency : {}".format(np.allclose(reconstructed_img, img)))
            print("Verification Annotation Consistency : {}".format(np.allclose(reconstructed_annotation, annotation)))
